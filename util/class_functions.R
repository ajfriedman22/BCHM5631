...
#' 
#' @description 
#' Generate a data frame for the binding location of a DNA binding protein on
#' any given promoter
#' 


#' 
#' @param peaks consensus peak files
#' @param promoter_gr GRanges for promoters in the genome of interest
#' @param window_size Promoter window size
#'
