...
rtracklayer::export(lncrna_mrna_promoters, "/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/11_consensus_peaks/gene_annotation_files/lncRNA_mrna_promoters.gtf")
...
lncrna_mrna_promoters <- rtracklayer::import("/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/11_consensus_peaks/gene_annotation_files/lncRNA_mrna_promoters.gtf")
...
# exporting
rtracklayer::export(lncrna_promoters, "/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/11_consensus_peaks/gene_annotation_files/lncrna_promoters.gtf")
...
# exporting
rtracklayer::export(mrna_promoters, "/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/11_consensus_peaks/gene_annotation_files/mrna_promoters.gtf") 
...
# exporting
rtracklayer::export(lncrna_mrna_genebody, "/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/11_consensus_peaks/gene_annotation_files/lncrna_mrna_genebody.gtf")
...
# exporting
rtracklayer::export(lncrna_genebody, "/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/11_consensus_peaks/gene_annotation_files/lncrna_genebody.gtf")
...
rtracklayer::export(mrna_genebody, "/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/11_consensus_peaks/gene_annotation_files/mrna_genebody.gtf")
...
consensus_fl <- list.files("/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/11_consensus_peaks/consensus_peaks", full.names = T)


consensus_peaks <- lapply(consensus_fl, rtracklayer::import)


names(consensus_peaks) <- gsub("/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/11_consensus_peaks/consensus_peaks/|_consensus_peaks.bed","", consensus_fl)
...
for(i in 1:length(filtered_consensus_peaks)) {
  rtracklayer::export(filtered_consensus_peaks[[i]], 
                      paste0("/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/11_consensus_peaks/filtered_consensus_peaks/", 
                             names(consensus_peaks)[i], 
...
# making a file list
filtered_consensus_peaks_files <- list.files("/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/11_consensus_peaks/filtered_consensus_peaks", 
                                             pattern = "*.bed",
                                             full.names = TRUE)
