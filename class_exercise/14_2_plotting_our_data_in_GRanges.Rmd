...
source("/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/util/plotting_functions.R")
source("/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/util/_setup.R")
library(Gviz)
library(ggpubr)
library(ggplot2)
```
...
num_peaks_df <- read.csv("/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/12_peak_features/num_peaks_df.csv")
...
peak_occurence_df <- read.csv("/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/12_peak_features/peak_occurence_dataframe.csv")
