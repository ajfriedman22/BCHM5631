...
num_peaks_df <- read_csv('/scratch/Shares/rinnclass/CLASS_2022/AF/BCHM5631/class_exercise/analysis/12_peak_features/num_peaks_df.csv')
...
# it's hard to see but in this case the contour is on bottom
# of points and points are above -- subtle but important
...
ggplot(num_peaks_df %>% filter(dbd %in% dbds),
       aes(x = num_peaks, y = total_peak_length/1e06 )) +
  facet_grid(dbd ~ tf) + 
  geom_point()
